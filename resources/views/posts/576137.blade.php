    ...
    <div class="container mt-4">
        ...
        <div class="row mb-5">
            <div class="col-10 post-cnt">
                <h2 class="title-1 mt-0">What is routing</h2>
                <p class="desc">
                ...
                <h2 class="title-1">What is Laravel Routing?</h2>
                <div class="desc">
                ...
                <h2 class="title-1">Defining Routes</h2>
                <div class="desc">
...
Route::get('/welcome', 'HomeController@index');</code></pre>
                ...
                <h2 class="title-1">Route Parameters</h2>
                <div class="desc">
